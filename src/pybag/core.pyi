...
class PyRoutingGrid:
    ...
    def get_direction(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_level_offset(self, level: int) -> int: ...
    def set_flip_parity(self, level: int, scale: int, offset: int) -> None: ...
...
class PyTech:
    ...
    def get_min_space(self, layer: str, width: int, purpose: str = '', same_color: bool = False) -> int: ...
    def get_via_id(self, bot_lay: str, bot_purp: str, top_lay: str, top_purp: str) -> str: ...
    def get_via_param(self, w: int, h: int, via_id: str, bot_dir: int, top_dir: int, extend: bool) -> ViaParam: ...
