...
class BBox:
    ...
    @overload
    def __init__(self, orient_code: bool, tl: int, th: int, pl: int, ph: int) -> None: ...
    ...
    def extend_orient(self, orient_code: bool, ct: Optional[int] = None, cp: Optional[int] = None) -> BBox: ...
    def flip_xy(self) -> BBox: ...
    def get_center(self, orient_code: bool) -> int: ...
    def get_coord(self, orient_code: bool, bnd_code: bool) -> int: ...
    def get_dim(self, orient_code: bool) -> int: ...
    def get_expand(self, dx: int = 0, dy: int = 0) -> BBox: ...
    def get_extend(self, x: Optional[int] = None, y: Optional[int] = None) -> BBox: ...
    def get_extend_orient(self, orient_code: bool, ct: Optional[int] = None, cp: Optional[int] = None) -> BBox: ...
    def get_flip_xy(self) -> BBox: ...
    def get_immutable_key(self) -> Tuple[int, int, int, int]: ...
    def get_intersect(self, bbox: BBox) -> BBox: ...
    def get_interval(self, orient_code: bool) -> Tuple[int, int]: ...
    @staticmethod
    def get_invalid_bbox() -> BBox: ...
    def get_merge(self, bbox: BBox) -> BBox: ...
    def get_move_by(self, dx: int = 0, dy: int = 0) -> BBox: ...
    def get_move_by_orient(self, orient_code: bool, dt: int = 0, dp: int = 0) -> BBox: ...
    ...
    def move_by_orient(self, orient_code: bool, dt: int = 0, dp: int = 0) -> BBox: ...
...
class BBoxArray:
    ...
    @overload
    def __init__(self, base: BBox, orient_code: bool, nt: int = 1, spt: int = 0, np: int = 1, spp: int = 0) -> None: ...
    def __eq__(self, other: BBoxArray) -> bool: ...
    def __iter__(self) -> Iterator[BBox]: ...
    def as_bbox(self) -> BBox: ...
    def as_bbox_collection(self) -> BBoxCollection: ...
    def extend_orient(self, orient_code: bool, ct: Optional[int] = None, cp: Optional[int] = None) -> BBoxArray: ...
    def get_array_info(self, orient_code: bool) -> Tuple[int, int]: ...
    def get_bbox(self, idx: int) -> BBox: ...
    def get_coord(self, orient_code: bool, bnd_code: bool) -> int: ...
    def get_copy(self) -> BBoxArray: ...
    def get_extend_orient(self, orient_code: bool, ct: Optional[int] = None, cp: Optional[int] = None) -> BBoxArray: ...
