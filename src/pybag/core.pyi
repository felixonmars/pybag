...
class PyLayCellView:
    ...
    def add_blockage(self, *args: Any, **kwargs: Any) -> Any: ...
    def add_boundary(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def add_path45_bus(self, *args: Any, **kwargs: Any) -> Any: ...
    def add_pin(self, layer: str, xl: int, yl: int, xh: int, yh: int, net: str, label: str) -> None: ...
    def add_poly(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def add_rect(self, layer: str, purpose: str, is_horiz: bool, xl: int, yl: int, xh: int, yh: int, commit: bool) -> PyRect: ...
    def add_rect_arr(self, layer: str, purpose: str, box: BBox, is_horiz: bool, nx: int, ny: int, spx: int, spy: int) -> None: ...
    def add_via_arr(self, xform: Transform, via_id: str, add_layers: bool, bot_horiz: bool, top_horiz: bool, vnx: int, vny: int, w: int, h: int, vspx: int, vspy: int, enc1x: int, enc1y: int, off1x: int, off1y: int, enc2x: int, enc2y: int, off2x: int, off2y: int, nx: int, ny: int, spx: int, spy: int) -> None: ...
