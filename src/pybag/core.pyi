...
class PyTech:
    ...
    def get_lay_purp_list(self, level: int) -> List[Tuple[str, str]]: ...
    def get_level(self, layer: str, purpose: str) -> Optional[int]: ...
    def get_min_length(self, layer: str, purpose: str, width: int, even: bool) -> int: ...
