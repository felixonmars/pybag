...
std::string bbox_repr(const c_box &self) {
    return fmt::format("BBox({}, {}, {}, {})", self.xl(), self.yl(), self.xh(), self.yh());
}
...
PYBIND11_MODULE(geometry, m) {
    ...
    py_box.def("__repr__", &pu::bbox_repr, "Returns a string representation of BBox.");
